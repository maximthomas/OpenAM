 ...
 */
@Singleton
public class HeaderAccessTokenVerifier extends AccessTokenVerifier {

    @Inject
    public HeaderAccessTokenVerifier(TokenStore tokenStore) {
        super(tokenStore);
    }
    ...
    protected String obtainTokenId(OAuth2Request request) {
        final String tokenId = request.getAuthorizationBearerToken();
