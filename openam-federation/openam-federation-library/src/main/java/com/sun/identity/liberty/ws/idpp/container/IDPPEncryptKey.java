...
public class IDPPEncryptKey extends IDPPBaseContainer {
     ...
     public Object getContainerObject(Map userMap) throws IDPPException {
        IDPPUtils.debug.message("IDPPEncryptKey:getContainerObject:Init");
         ...
         if(certBytes != null) {
            ...
            JAXBElement<byte[]> cert = of.createX509DataTypeX509Certificate(
                      certBytes[0]);
     ...
     throws IDPPException {
        ...
        if(dataElement instanceof JAXBElement && "EncryptKey".equals(((JAXBElement<?>) dataElement).getName().getLocalPart())) {
           byte[] certBytes = null;
           JAXBElement<KeyInfoType> encryptKey = (JAXBElement<KeyInfoType>)dataElement;
           ...
           while(iter.hasNext()) {
             ...
             if(obj instanceof
                ...
                if(certObj instanceof
                   JAXBElement) {
                   JAXBElement<byte[]> cert =
                   (JAXBElement<byte[]>)certObj;
