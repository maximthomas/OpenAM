...
/*
 * ES module port of src/test/js/store/actions/typesTest.js -- same tests, same names, same
 * order. `store/actions/types` has named exports and no default, so the AMD module value the
 * define() wrapper received is a namespace import here.
 */
