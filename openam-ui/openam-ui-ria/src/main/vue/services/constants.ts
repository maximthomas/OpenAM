...
export const Constants = {
  ...
  EVENT_DIALOG_CLOSE: 'dialog.EVENT_DIALOG_CLOSE',
  EVENT_SHOW_DIALOG: 'dialog.EVENT_SHOW_DIALOG',
  ...
  EVENT_LOGIN_REQUEST: 'user.login.EVENT_LOGIN_REQUEST',
  ...
  EVENT_CONFIGURATION_CHANGED: 'main.Configuration.EVENT_CONFIGURATION_CHANGED',
  ...
  EVENT_DEPENDENCIES_LOADED: 'main.EVENT_DEPENDENCIES_LOADED',
  ...
  EVENT_INVALID_REALM: 'main.EVENT_INVALID_REALM',
  ...
  DEFAULT_STYLESHEETS: ['css/bootstrap-3.3.5-custom.css', 'css/styles-admin.css'] as const,
  ...
  EVENT_REDIRECT_TO_JATO_AGENTS_OAUTH20: 'main.navigation.EVENT_REDIRECT_TO_JATO_AGENTS_OAUTH20',
  EVENT_REDIRECT_TO_JATO_AGENTS_JAVA: 'main.navigation.EVENT_REDIRECT_TO_JATO_AGENTS_JAVA',
  EVENT_REDIRECT_TO_JATO_AGENTS_WEB: 'main.navigation.EVENT_REDIRECT_TO_JATO_AGENTS_WEB',
  EVENT_REDIRECT_TO_JATO_DATASTORE: 'main.navigation.EVENT_REDIRECT_TO_JATO_DATASTORES',
  EVENT_REDIRECT_TO_JATO_PRIVILEGES: 'main.navigation.EVENT_REDIRECT_TO_JATO_PRIVILEGES',
  EVENT_REDIRECT_TO_JATO_SUBJECTS: 'main.navigation.EVENT_REDIRECT_TO_JATO_SUBJECTS',
  EVENT_REDIRECT_TO_JATO_STS: 'main.navigation.EVENT_REDIRECT_TO_JATO_STS',
} as const;
